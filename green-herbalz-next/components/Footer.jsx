...
export default function Footer() {
  return (
    <footer translate="no" className="notranslate py-12 md:py-16 px-4 md:px-8 border-t border-outline-variant/20 bg-surface" role="contentinfo">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-4">
          <Image
            src="/brand-logo.png"
            alt="Green Herbalz — Homemade Botanical Skincare Brand Logo"
            width={40}
            height={40}
        ...
        <nav className="flex items-center gap-6 text-on-surface-variant text-sm font-light" aria-label="Footer navigation">
